...
(function() {
    ...
    const UGF_LAYOUT_SUFFIX = [
        ...
        [' (Disable the script for present google, this can also act as "Present google but no AI")', "now"]
    ];
